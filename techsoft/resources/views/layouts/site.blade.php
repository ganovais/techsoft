...
<head>
    ...
    <!-- 600X315 -->
    <meta itemprop="image" content="https://ganovais.github.io/techsoft/assets/images/meta.png" />
    <meta property="og:image" content="https://ganovais.github.io/techsoft/assets/images/meta.png" />
    ...
    <link rel="stylesheet" href="{{ asset('site/assets/plugins/fontawesome-free-5.15.3-web/css/all.min.css') }}" />
</head>

<body>
    <nav class="navbar navbar-expand-lg header-menu navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">TechSoft</a>
